    ...
    .controller('messageCtrl', ['$scope', '$stateParams',
      ...
      function ($scope, $stateParams, messageService, $ionicScrollDelegate, $ionicActionSheet, $timeout, $ionicLoading) {
        ...
        $scope.doRefresh = function () {
          ...
          $scope.messageNum += 5;
          $timeout(function () {
            $scope.messages = messageService.getAmountMessageById($scope.messageNum,
                $stateParams.chatId);
        ...
        $scope.$on("$ionicView.beforeEnter", function () {
          $scope.chat = messageService.getChatById($stateParams.chatId);
          $scope.chat.noReadMessages = 0;
          $scope.chat.showHints = false;
